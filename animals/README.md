...
| <span style="font-size: 30px">🐾</span> | **モモンガドラキュラの生存記録🐾**<br>(Sugar Glider Dracula)<br>![WebApp](https://img.shields.io/badge/WEBアプリ！-purple) | **ライフログ & ゲーム**<br>太陽を避けて装備を整え、称号を手に入れよう。 | [🔍 HTML](../static/dracula.html)<br> |
